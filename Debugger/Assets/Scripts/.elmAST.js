...
var _Bogdanp$elm_ast$Ast2Json$jmap = F2(
	function (f, l) {
		return _elm_lang$core$Json_Encode$list(
			A2(_elm_lang$core$List$map, f, l));
	});
var _Bogdanp$elm_ast$Ast2Json$elmtype = function (t) {
	var _p0 = t;
	switch (_p0.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('TypeApplication')
					},
						{
						ctor: '_Tuple2',
						_0: 'from',
						_1: _Bogdanp$elm_ast$Ast2Json$elmtype(_p1)
					},
						{
						ctor: '_Tuple2',
						_0: 'to',
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('TypeVariable')
					},
						{
						ctor: '_Tuple2',
						_0: 'name',
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('TypeConstructor')
					},
						{
						ctor: '_Tuple2',
						_0: 'name',
						_1: A2(_Bogdanp$elm_ast$Ast2Json$jmap, _elm_lang$core$Json_Encode$string, _p0._0)
					},
						{
						ctor: '_Tuple2',
						_0: 'subtypes',
						_1: A2(_Bogdanp$elm_ast$Ast2Json$jmap, _Bogdanp$elm_ast$Ast2Json$elmtype, _p0._1)
					}
					]));
		default:
			return _elm_lang$core$Json_Encode$string(
				_elm_lang$core$Basics$toString(_elm_lang$core$Basics$e));
	}
};
var _Bogdanp$elm_ast$Ast2Json$expression = function (e) {
	var _p2 = e;
	switch (_p2.ctor) {
		case 'String':
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('Variable')
					},
						{
						ctor: '_Tuple2',
						_0: 'identifier',
						_1: A2(_Bogdanp$elm_ast$Ast2Json$jmap, _elm_lang$core$Json_Encode$string, _p2._0)
					}
					]));
		case 'BinOp':
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('Infix')
					},
						{
						ctor: '_Tuple2',
						_0: 'left',
						_1: _Bogdanp$elm_ast$Ast2Json$expression(_p2._1)
					},
						{
						ctor: '_Tuple2',
						_0: 'op',
						_1: _Bogdanp$elm_ast$Ast2Json$expression(_p2._0)
					},
						{
						ctor: '_Tuple2',
						_0: 'right',
						_1: _Bogdanp$elm_ast$Ast2Json$expression(_p2._2)
					}
					]));
		case 'Range':
			return _elm_lang$core$Json_Encode$object(
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('List')
					},
						{
						ctor: '_Tuple2',
						_0: 'content',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$map, _Bogdanp$elm_ast$Ast2Json$expression, _p2._0))
					}
					]));
		case 'Application':
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('Application')
					},
						{
						ctor: '_Tuple2',
						_0: 'receiver',
...
var _Bogdanp$elm_ast$Ast2Json$exports = function (e) {
	var _p3 = e;
	switch (_p3.ctor) {
		case 'AllExport':
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('ExportAll')
					}
					]));
		case 'SubsetExport':
			return A2(_Bogdanp$elm_ast$Ast2Json$jmap, _Bogdanp$elm_ast$Ast2Json$exports, _p3._0);
		case 'FunctionExport':
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('ExportFunction')
					},
						{
						ctor: '_Tuple2',
						_0: 'name',
...
var _Bogdanp$elm_ast$Ast2Json$statement = function (s) {
	var _p4 = s;
	switch (_p4.ctor) {
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('ModuleDecl')
					},
						{
						ctor: '_Tuple2',
						_0: 'name',
						_1: A2(_Bogdanp$elm_ast$Ast2Json$jmap, _elm_lang$core$Json_Encode$string, _p4._0)
					},
						{
						ctor: '_Tuple2',
						_0: 'exports',
						_1: _Bogdanp$elm_ast$Ast2Json$exports(_p4._1)
					}
					]));
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('FuncType')
					},
						{
						ctor: '_Tuple2',
						_0: 'name',
						...
						ctor: '_Tuple2',
						_0: 'type',
						_1: _Bogdanp$elm_ast$Ast2Json$elmtype(_p4._1)
					}
					]));
			...
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'ast_type',
						_1: _elm_lang$core$Json_Encode$string('FuncDecl')
					},
						{
						ctor: '_Tuple2',
						_0: 'name',
						...
						ctor: '_Tuple2',
						_0: 'args',
						_1: A2(_Bogdanp$elm_ast$Ast2Json$jmap, _elm_lang$core$Json_Encode$string, _p4._1)
					},
						{
						ctor: '_Tuple2',
						_0: 'expr',
						_1: _Bogdanp$elm_ast$Ast2Json$expression(_p4._2)
					}
					]));
		default:
			return _elm_lang$core$Json_Encode$string(
...
var _Bogdanp$elm_ast$Main$jsonify = function (m) {
	var _p0 = _Bogdanp$elm_ast$Ast$parse(m);
	if ((_p0.ctor === '_Tuple2') && (_p0._0.ctor === 'Ok')) {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			2,
			A2(_Bogdanp$elm_ast$Ast2Json$jmap, _Bogdanp$elm_ast$Ast2Json$statement, _p0._0._0));
	} else {
		return '';
	}
};
var _Bogdanp$elm_ast$Main$replyJsonAst = _elm_lang$core$Native_Platform.outgoingPort(
	'replyJsonAst',
	function (v) {
		return v;
	});
var _Bogdanp$elm_ast$Main$parseElmCode = _elm_lang$core$Native_Platform.incomingPort('parseElmCode', _elm_lang$core$Json_Decode$string);
var _Bogdanp$elm_ast$Main$Model = {};
var _Bogdanp$elm_ast$Main$update = F2(
	function (msg, _p1) {
		var _p2 = msg;
		return {
			ctor: '_Tuple2',
			_0: _Bogdanp$elm_ast$Main$Model,
			_1: _Bogdanp$elm_ast$Main$replyJsonAst(
				_Bogdanp$elm_ast$Main$jsonify(_p2._0))
		};
	});
var _Bogdanp$elm_ast$Main$ParseElm = function (a) {
	return {ctor: 'ParseElm', _0: a};
};
var _Bogdanp$elm_ast$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _Bogdanp$elm_ast$Main$Model, _1: _elm_lang$core$Platform_Cmd$none},
			view: function (_p3) {
				return A2(
			...
			update: _Bogdanp$elm_ast$Main$update,
			subscriptions: function (_p4) {
				return _Bogdanp$elm_ast$Main$parseElmCode(_Bogdanp$elm_ast$Main$ParseElm);
			}
		})
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _Bogdanp$elm_ast$Main$main === 'undefined' ? null : _Bogdanp$elm_ast$Main$main);
